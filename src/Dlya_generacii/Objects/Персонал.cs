...
namespace IIS.Dlya_generacii
{
    ...
    public class Персонал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dlya_generacii.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Dlya_generacii.Должности Должности
        {
            get
            {
                ...
                IIS.Dlya_generacii.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПерсоналE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналE", typeof(IIS.Dlya_generacii.Персонал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПерсоналL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналL", typeof(IIS.Dlya_generacii.Персонал));
                }
            }
        }
    }
