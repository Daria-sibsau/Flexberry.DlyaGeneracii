...
moduleForModel('i-i-s-dlya-generacii-т-ч-перечень-усл', 'Unit | Serializer | i-i-s-dlya-generacii-т-ч-перечень-усл', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dlya-generacii-т-ч-перечень-усл',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
