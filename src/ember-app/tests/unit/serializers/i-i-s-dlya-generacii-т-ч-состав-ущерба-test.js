...
moduleForModel('i-i-s-dlya-generacii-т-ч-состав-ущерба', 'Unit | Serializer | i-i-s-dlya-generacii-т-ч-состав-ущерба', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dlya-generacii-т-ч-состав-ущерба',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
